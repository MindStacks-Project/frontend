...
type CalendarCustomComponents = NonNullable<CalendarProps["components"]>;

const defaultCalendarComponents: CalendarCustomComponents = {
  Chevron: ({
    className,
    orientation,
    size,
...
function Calendar({
  ...
  const mergedComponents = React.useMemo(() => {
    if (!components) {
      return defaultCalendarComponents;
    }

    return {
      ...defaultCalendarComponents,
      ...components,
    } satisfies CalendarCustomComponents;
  }, [components]);
